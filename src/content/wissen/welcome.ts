...
export const wissenWelcome = {
  title: "Willkommen",
  metaDescription:
    "Medienfair Wissen: Begriffe und Konzepte für Unternehmen – von Positionierung über Website und Marketing bis Recht und Prozesse.",
  intro:
    "Diese Wissensdatenbank erklärt die zentralen Begriffe rund um Online-Marketing, Website und Vertrieb für Unternehmen. Du findest hier keine Produktwerbung, sondern klare Einordnungen – damit du Entscheidungen für deinen Auftritt besser verstehst und mit uns gezielter sprechen kannst.",
  callout:
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Unter /wissen bündeln wir Fachbegriffe und Konzepte, die im Alltag von Unternehmen immer wieder auftauchen – wenn es um Website, Google, Meta Ads, Anfragen oder rechtliche Basics geht. Jeder Eintrag erklärt ein Thema verständlich: Was bedeutet es, warum ist es relevant, und worauf solltest du achten?",
        ...
        "Neue Einträge und Vertiefungen kommen laufend dazu. Wenn du einen Begriff vermisst oder etwas unklar ist, melde dich gerne – wir ergänzen die Datenbank, wo es für Unternehmen wirklich hilft.",
      ],
    },
    {
      id: "fuer-wen",
      ...
      paragraphs: [
        "Primär für Unternehmen und KMUs, die online professionell auftreten und planbar qualifizierte Anfragen oder Partner gewinnen wollen. Du musst kein Marketing-Profi sein – die Texte setzen kein Vorwissen voraus.",
