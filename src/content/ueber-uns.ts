...
export const ueberUnsPage: ServicePageContent = {
  ...
  badge: "Über uns",
  metaDescription:
    "Medienfair: Team aus sieben Experten für Online-Systeme von Finanzberatern – Positionierung, Website, SEO und Ads aus einer Hand.",
  accent: "#4562D7",
  badgeBg: "#4562D70F",
  badgeBorder: "#4562D700",
  badgeText: "#4562D799",
  benefitIconBg: "#4562D714",
  headline: "Ein Team. Ein System. Für Finanzberater.",
  subline:
  ...
  benefits: [
    ...
    {
      text: "Jahrzehnte Erfahrung. Aus Hobby wurde Handwerk – heute mit klarem Fokus auf Finanzberater und Finanzdienstleister.",
      icon: "clock",
    },
    {
    ...
    sections: [
      {
        heading: "Unser Fokus",
        paragraphs: [
          "Wir arbeiten vor allem mit Finanzberatern und Finanzdienstleistern, die online professionell auftreten und planbar Kunden oder Partner gewinnen wollen.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "DSGVO, Seriosität und Vertrauen sind für uns selbstverständlich – besonders im Finanzbereich.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Klare Kommunikation, feste Ansprechpartner und Lösungen, die zu deinem Alltag als Berater passen.",
