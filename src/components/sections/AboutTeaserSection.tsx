  ...
  return (
    <section id="ueber-uns" className={`bg-white py-16 ${fontInter}`}>
      <Reveal className="mx-auto flex w-full max-w-3xl flex-col items-center gap-5 px-5">
        <h2 className="flex max-w-lg flex-wrap justify-center text-center text-4xl font-medium leading-[111%] text-balance text-[#1b263b]">
          Aber warum Medienfair?
        </h2>
        <p className="flex max-w-md flex-wrap justify-center text-center text-lg font-medium leading-6 text-[#1b263b]/70">
        ...
        <Link
          href="/ueber-uns"
          className={`inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-[#1b263b]/[0.08] px-5 text-base font-medium leading-[150%] text-[#1b263b] transition-colors hover:bg-[#1b263b]/[0.12] ${superellipse}`}
        >
          Mehr zu uns
        </Link>
      </Reveal>
