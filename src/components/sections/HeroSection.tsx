...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center gap-16 overflow-hidden bg-white pb-16 pt-10">
      <Reveal className="mx-auto flex w-full max-w-3xl flex-col items-center gap-[17px] px-5">
        <motion.a
          href="#kontakt"
          whileHover={{ scale: 1.02 }}
          className="flex items-center gap-2 rounded-full bg-[#2C78FC14] py-1.5 pl-1.5 pr-2.5"
        >
          <span
            className="flex h-5 items-center justify-center rounded-full px-1.5 text-xs font-medium capitalize text-white"
            style={{
              backgroundImage:
          ...
          <span className="text-sm font-medium text-[#2C78FC]">
            Kostenlose Analyse anfragen
          </span>
          <ChevronRight stroke="#2C78FC" className="-ml-1 h-4 w-4" />
        </motion.a>
        ...
        <p className="max-w-md text-center text-lg font-medium leading-6 text-[#666666]">
          Klare Systeme für Finanzberater – für mehr Sichtbarkeit, Vertrauen und
