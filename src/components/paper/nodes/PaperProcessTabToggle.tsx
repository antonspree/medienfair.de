...
export function PaperProcessTabToggle({
  ...
  return (
    <div className="flex w-fit shrink-0 flex-col gap-2">
      <div className="flex w-[174px] items-center justify-center gap-1 rounded-full border border-solid border-[#E8E8E8] bg-white p-1">
        <button
          type="button"
        ...
        >
          ...
          <span className="relative text-center font-['Inter',system-ui,sans-serif] text-sm font-medium leading-[142.857%] text-[#181925]">
            Kunden
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="relative font-['Inter',system-ui,sans-serif] text-sm font-medium leading-[142.857%] text-[#181925]">
            Partner
          </span>
        </button>
      </div>
